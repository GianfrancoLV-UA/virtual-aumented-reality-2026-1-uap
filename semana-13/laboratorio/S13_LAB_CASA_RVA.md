...
[Explica cómo funciona SubtitulosXR.cs — por qué usa LateUpdate, por qué el Canvas
es World Space, cómo el suavizadoMovimiento evita el jitter]

### Capturas de evidencia
(Pegar capturas del subtítulo funcionando — una estática, una mostrando que sigue la cabeza)

### Integración con el proyecto
¿En qué parte del proyecto integraste los subtítulos? ¿Qué eventos los disparan?
[Respuesta en 3-5 líneas]

### Reflexión de accesibilidad
¿Qué usuarios podría usar tu proyecto ahora que antes no podía?
¿Cuántas personas aproximadamente (estadística global) se benefician de esta feature?
[Respuesta en 3-5 líneas]
...
### Descripción del sistema implementado
[Explica cómo funciona GestorAccesibilidadColor.cs — qué tipos de daltonismo cubre,
cómo el usuario cambia el modo]

### Captura del menú de accesibilidad
(Pegar captura del menú abierto mostrando los controles)

### Tipos de daltonismo cubiertos
| Tipo | Prevalencia | Impacto sin este ajuste |
|------|-------------|------------------------|
| Protanopia | 1% de hombres | |
| Deuteranopia | 5% de hombres | |
| Tritanopia | 0.01% | |

### Reflexión de diseño
¿Qué información de tu proyecto estaba codificada solo en color?
¿Cómo lo resolviste (o cómo lo resolverías) para ser más robusto además del filtro?
[Respuesta en 3-5 líneas]
...
Después de implementar los dos sistemas, vuelve a hacer la auditoría del lab de clase:
...
| Subtítulos para eventos de audio | | | |
| Menú de accesibilidad disponible | | | |

### Criterios aún no cumplidos y plan de acción
[Lista los criterios que todavía no cumples y cómo los abordarías si tuvieras más tiempo]

---

## REFLEXIÓN FINAL (obligatorio — mínimo 150 palabras)

Responde: ¿Por qué la accesibilidad en XR es más compleja que en una app web convencional?
¿Qué aprendiste sobre diseño inclusivo que puedas aplicar en futuros proyectos profesionales?
¿Qué usuario específico real (con nombre ficticio y discapacidad concreta) podría ahora
usar tu proyecto que antes no podía?
```
